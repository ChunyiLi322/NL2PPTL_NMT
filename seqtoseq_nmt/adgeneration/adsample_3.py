...
string_file_begin = "/home/lcy/adsample/seqtoseq_nmt-masterOKpy36/seqtoseq_nmt-master/assets/cmn-eng/test/"
...
def record_input_dataset(_path_to_file):
    ...
    for line in file:
        ...
        input_batch = tokenizer.cut(input_batch)
        string_line_0 = ""
        for line_1 in input_batch:
            string_line_0 = string_line_0 + line_1 + " "
        sentences.append(string_line_0)
...
def adsample_generation(number_input):    
    ...
    nlp=StanfordCoreNLP(r'/home/lcy/adsample/NCR2Code/',lang="zh")
    ...
    for m,n in zip(word_dict,word_tag):
        if n == 'NR' or n == 'NT' or n == 'NN':
        # if n == 'VV' or n == 'VC' or n == 'VE'  or n == 'VA':
        # if n == 'AD' or n == 'JJ':
